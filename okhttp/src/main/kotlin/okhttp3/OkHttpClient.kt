...
internal constructor(builder: Builder) :
    ...
    init {
        ...
        if (connectionSpecs.none { it.isTls }) {
            LogUtils.d(TAG, "类初始化阶段：这里检测到connectionSpecs中没有元素")
            this.sslSocketFactoryOrNull = null
            this.certificateChainCleaner = null
            this.x509TrustManager = null
            this.certificatePinner = CertificatePinner.DEFAULT
        } else if (builder.sslSocketFactoryOrNull != null) {
            LogUtils.d(TAG, "类初始化阶段：这里检测到sslSocketFactory不为空")
            ...
            LogUtils.d(TAG, "类初始化阶段：这里检测到connectionSpecs中有元素，且sslSocketFactory为空！！！")
    ...
    class Builder constructor() {
        ...
        fun sslSocketFactory(sslSocketFactory: SSLSocketFactory) = apply {
            ...
            this.x509TrustManagerOrNull = Platform.get().trustManager(sslSocketFactory)
